...
Report bugs at https://github.com/./yolov5/issues
...
Ready to contribute? Here's how to set up `yolov5` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `yolov5` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/yolov5.git
